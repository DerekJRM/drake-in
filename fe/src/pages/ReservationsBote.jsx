...
import "../styles/reservationsBote.css";
                ...
                <div className="col-12">
                      ...
                      Llegadas por Horario - {reservationsList[0]?.hotel || "Hotel"}
                        ...
                        <div className="time-section">
                          <div className="time-badge">
                            ...
                            <span>{schedule} - {reservationsList.length} personas</span>
                          </div>
                  ...
                  {Object.keys(groupedReservations).length === 0 && (
                      <div className="alert alert-info" role="alert">
                        <i className="bi bi-info-circle"></i> No hay reservaciones para mostrar
                      </div>
                  )}
                </div>
              </div>
