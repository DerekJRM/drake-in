...
import { Navbar as RBNavbar, Nav, Card } from "react-bootstrap";
...
const Navbar = () => {
  ...
  return (
    <RBNavbar expand="lg" className="mb-2">
        <Card className="w-100 border-0 rounded" style={{ backgroundColor: '#6a92b2' }}>
              ...
              <RBNavbar.Collapse id="basic-navbar-nav" className="flex-grow-0">
                <Nav className="gap-2 d-flex align-items-center">
                  <Nav.Link
                    ...
                    style={{ 
                      backgroundColor: location.pathname === ROUTES.HOME ? 'rgba(255,255,255,0.2)' : 'transparent',
                      transition: 'all 0.2s'
                    }}
                  >
                    Inicio
                  ...
                  <Nav.Link
                    ...
                    className="text-white px-3 py-2 rounded fw-medium"
                    style={{ 
                      backgroundColor: location.pathname === ROUTES.RESERVACIONES ? 'rgba(255,255,255,0.2)' : 'transparent',
                      transition: 'all 0.2s'
                    }}
                  >
                    Ver Reservaciones
                  ...
                  <Nav.Link
                    ...
                    className="text-white px-3 py-2 rounded fw-medium"
                    style={{ 
                      backgroundColor: location.pathname === ROUTES.RUTAS ? 'rgba(255,255,255,0.2)' : 'transparent',
                      transition: 'all 0.2s'
                    }}
                  >
                    Administrar Rutas
                  ...
                  <Nav.Link
                    ...
                    className="text-white px-3 py-2 rounded fw-medium"
                    style={{ 
                      backgroundColor: location.pathname === ROUTES.REGISTRO ? 'rgba(255,255,255,0.2)' : 'transparent',
                      transition: 'all 0.2s'
                    }}
                  >
                    Registrar Operador
                  ...
                  <Nav.Link
                    ...
                    className="text-white px-3 py-2 rounded fw-medium"
                    style={{ 
                      backgroundColor: location.pathname === ROUTES.LOGIN ? 'rgba(255,255,255,0.2)' : 'transparent',
                      transition: 'all 0.2s'
                    }}
                  >
                    Iniciar Sesión
